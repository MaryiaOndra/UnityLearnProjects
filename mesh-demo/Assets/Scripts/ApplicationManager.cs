...
namespace WallGenerator
{
    ...
    public class ApplicationManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            floorMesh = new FloorMeshGenerator();
        }
        ...
        void Start()
        {
            ...
            floorBtn.onClick.AddListener(GenerateFloor);
        }

        void GenerateFloor() 
        {
            Vector2[] _floorVertices = meshGenerator.CreateArrayForFloor();
            floorMesh.GenerateFloor(_floorVertices, floorMat);
        }
